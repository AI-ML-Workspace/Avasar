...
2. Zero Hallucination: Do NOT invent scheme details, financial assistance amounts, eligibility rules, or deadlines.
3. No External Assumptions: Do NOT extrapolate beyond the facts directly provided in the context.
4. Handling Missing Data: If the provided Scheme Context does not contain enough information to answer the question, clearly state: "Based on the verified government scheme records currently available, there is not enough information to answer this question." Do NOT guess or speculate.
5. Direct & Structured: Answer the user's question directly. Highlight key scheme names, eligibility criteria, benefits, and application steps mentioned in the context.
6. Tone: Helpful, factual, polite, and accessible to Indian citizens.
"""
...
class LLMService:
    ...
    async def generate_answer(
        ...
        """Generate a grounded scheme explanation based on retrieved context.
        ...
        user_prompt = (
            ...
            f"Please answer the question accurately based strictly on the Scheme Context above."
        )
