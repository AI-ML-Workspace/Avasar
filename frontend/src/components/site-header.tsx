    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        <Link href="/" className="flex items-center gap-3 group transition">
          <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white p-0.5 shadow-md ring-2 ring-accent/30 transition group-hover:scale-105">
            <Image
              src="/logo.png"
              alt="Avasar Logo"
              width={44}
        ...
        >
          ...
          <Link
            href="/chat"
            className="ml-1 rounded-xl bg-primary px-4 py-2 text-primary-foreground font-semibold shadow-soft hover:bg-primary/90 border border-accent/40 transition"
          >
            Ask Avasar
          </Link>
        </nav>
